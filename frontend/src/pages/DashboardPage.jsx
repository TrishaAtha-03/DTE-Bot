...
function HostelSection() {
  ...
  useEffect(() => {
    api.get('/admin/hostel').then(r => { setData(r.data || {}); setForm(r.data || {}) }).catch(() => {})
  }, [])

  const save = async () => {
    try {
      await api.post('/admin/hostel', { ...form, is_available: form.is_available === true || form.is_available === 'true' })
    ...
    <div style={{display:'flex',height:'100vh',overflow:'hidden',background:'var(--gray-50)'}}>
      ...
      <main style={{flex:1,overflow:'auto',padding:24}}>
        ...
        <div style={{
          ...
          <div>
            <h1 style={{fontSize:22,fontWeight:800,color:'var(--gray-800)'}}>
